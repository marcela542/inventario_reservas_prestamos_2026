...
<style>
    ...
    .carrito-items::-webkit-scrollbar-thumb { background: #c5d4f5; border-radius: 4px; }

    /* Badge item carrito — override del JS que usa clases bootstrap */
    #lista-seleccionados .bg-primary {
    ...
    @media (max-width: 576px) {
        ...
        .prest-divider{ margin: 0.4rem 1rem 0.7rem; }
        .btn-prim, .btn-sec, .btn-ok { width: 100%; justify-content: center; }
        .prest-actions-between { flex-direction: column; }
    }
</style>
            ...
            <div class="prest-card">
                ...
                <div class="prest-header">
                    ...
                    <div class="prest-header-text">
                        ...
                        <p>Completa los pasos para registrar un nuevo préstamo</p>
                    </div>
                </div>
                ...
                <div class="prest-body">
                    ...
                    <!-- ===== CAROUSEL (sin cambios funcionales) ===== -->
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="carrito-card">
                                                ...
                                                <div id="lista-seleccionados" class="carrito-items"></div>
                                            </div>
                                        </div>
                                ...
                                <form id="formPaso2" action="<?= getUrl('prestamos', 'prestamos', 'postInsert'); ?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="fecha_prestamo" required min="<?= date('Y-m-d') ?>" name="fecha_prestamo">
                                    ...
                                    <!-- Botones paso 2 -->
                                    <div class="prest-actions-between">
...
<script>
    ...
    $('#formPaso1').submit(function(e) {
        ...
        for (const id in elementosSeleccionados) {
            if (elementosSeleccionados[id].tipo == 1) { hayDevolutivo = true; break; }
        }
        if (!hayDevolutivo) {
            Swal.fire({ icon: 'warning', title: 'Atención', text: 'Debe seleccionar al menos un elemento DEVOLUTIVO.', confirmButtonColor: '#3c56c7' });
            return;
        }
        ...
        let html = '';
        for (const id in elementosSeleccionados) {
            let cantidad = cantidadesSeleccionadas[id] ? ` <span class="badge" style="background:#eef1fb;color:#3c56c7;border:1px solid #d6e0fa;border-radius:5px;padding:2px 8px;font-size:11px;">Cantidad: ${cantidadesSeleccionadas[id]}</span>` : '';
            html += `<li style="color:#2d4080;font-size:13px;">${elementosSeleccionados[id].nombre}${cantidad}</li>`;
        }
